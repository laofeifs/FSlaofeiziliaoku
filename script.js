    ...
    "10": [
        {
            ...
            "generation": "10代超特",
            "description": "10代超特角色",
            "image": "characters/10代超特/德拉科夫.png",
            "actions": [
                {"name": "三分球", "gif": "gifs/10代超特/德拉科夫/三分球.gif"},
                {"name": "不看人传球", "gif": "gifs/10代超特/德拉科夫/不看人传球.gif"},
                {"name": "中手冒", "gif": "gifs/10代超特/德拉科夫/中手冒.gif"},
                {"name": "中投", "gif": "gifs/10代超特/德拉科夫/中投.gif"},
                {"name": "分球", "gif": "gifs/10代超特/德拉科夫/分球.gif"},
                {"name": "基本运球", "gif": "gifs/10代超特/德拉科夫/基本运球.gif"},
                {"name": "大手冒", "gif": "gifs/10代超特/德拉科夫/大手冒.gif"},
                {"name": "小手冒", "gif": "gifs/10代超特/德拉科夫/小手冒.gif"},
                {"name": "快速回防", "gif": "gifs/10代超特/德拉科夫/快速回防.gif"},
                {"name": "扑球", "gif": "gifs/10代超特/德拉科夫/扑球.gif"},
                {"name": "抢断", "gif": "gifs/10代超特/德拉科夫/抢断.gif"},
                {"name": "篮板", "gif": "gifs/10代超特/德拉科夫/篮板.gif"},
                {"name": "近上", "gif": "gifs/10代超特/德拉科夫/近上.gif"},
                {"name": "近扣", "gif": "gifs/10代超特/德拉科夫/近扣.gif"},
                {"name": "近投", "gif": "gifs/10代超特/德拉科夫/近投.gif"},
                {"name": "远上", "gif": "gifs/10代超特/德拉科夫/远上.gif"},
                {"name": "远扣", "gif": "gifs/10代超特/德拉科夫/远扣.gif"},
                {"name": "间接进攻手突破", "gif": "gifs/10代超特/德拉科夫/间接进攻手突破.gif"}
            ]
        },
        {
            "id": "10_2",
            ...
            "generation": "10代超特",
            "description": "10代超特角色",
            "image": "characters/10代超特/晓茹.png",
            "actions": [
                {"name": "三分球", "gif": "gifs/10代超特/晓茹/三分球.gif"},
                {"name": "不看人传球", "gif": "gifs/10代超特/晓茹/不看人传球.gif"},
                {"name": "中手冒", "gif": "gifs/10代超特/晓茹/中手冒.gif"},
                {"name": "中投", "gif": "gifs/10代超特/晓茹/中投.gif"},
                {"name": "分球", "gif": "gifs/10代超特/晓茹/分球.gif"},
                {"name": "基本运球", "gif": "gifs/10代超特/晓茹/基本运球.gif"},
                {"name": "大手冒", "gif": "gifs/10代超特/晓茹/大手冒.gif"},
                {"name": "小手冒", "gif": "gifs/10代超特/晓茹/小手冒.gif"},
                {"name": "快速回防", "gif": "gifs/10代超特/晓茹/快速回防.gif"},
                {"name": "扑球", "gif": "gifs/10代超特/晓茹/扑球.gif"},
                {"name": "抢断", "gif": "gifs/10代超特/晓茹/抢断.gif"},
                {"name": "篮板", "gif": "gifs/10代超特/晓茹/篮板.gif"},
                {"name": "近上", "gif": "gifs/10代超特/晓茹/近上.gif"},
                {"name": "近扣", "gif": "gifs/10代超特/晓茹/近扣.gif"},
                {"name": "近投", "gif": "gifs/10代超特/晓茹/近投.gif"},
                {"name": "远上", "gif": "gifs/10代超特/晓茹/远上.gif"},
                {"name": "远扣", "gif": "gifs/10代超特/晓茹/远扣.gif"},
                {"name": "间接进攻手突破", "gif": "gifs/10代超特/晓茹/间接进攻手突破.gif"}
            ]
        },
        {
            "id": "10_3",
...
// 全国联赛活动专题（兼容旧调用名 openFSPLActivity）
function openFSPLActivity() {
    try {
        const fsplUrl = 'https://www.fsjoy.com/fsa2026/fsa-events.html';
        const isMobile = /Mobile|Android|iPhone|iPad/.test(navigator.userAgent);
        const isWeChat = /MicroMessenger/i.test(navigator.userAgent);
        
        console.log('全国联赛专题跳转 - 设备检测:', {isMobile, isWeChat});
        ...
        console.error('全国联赛专题跳转失败:', error);
        window.location.href = 'https://www.fsjoy.com/fsa2026/fsa-events.html';
    }
}
